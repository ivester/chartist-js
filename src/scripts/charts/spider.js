...
(function(window, document, Chartist){
  ...
  /**
   * Default options in Spider charts. Expand the code view to see a detailed list of options with comments.
   *
   * @memberof Chartist.Spider
   */
  var defaultOptions = {
    // Options for X-Axis
    axisX: {
  ...
  /**
   * This method creates a new spider chart.
   *
   * @memberof Chartist.Spider
   ...
   *
   */
  function Spider(query, data, options, responsiveOptions) {
    Chartist.Spider.super.constructor.call(this,
      query,
      data,
      defaultOptions,
  ...
  Chartist.Spider = Chartist.Base.extend({
    constructor: Spider,
